...
ρ-conf-rec : ∀{θ El Er ql qr i oli ori qro qlo FV BV θl θr}
...
... | (θo , whatever , Erl , Ero , thig , oolieq , sireq , sileq , rlout , rrout , viewlo , viewro , _) = θo , whatever , Erl , Ero , thig , oolieq , sireq , sileq , rlout , rrout , viewlo , viewro
...
... | (redl2 , viewl2) | (redr2 , viewr2) with ρ-conf-rec2{El = epar₂ q ∷ El}{epar₁ p ∷ Er}{oli = oli2}{ori = ori2} (CBρ (CBpar cbr cbl (distinct-sym a) (distinct-sym c) (distinct-sym b) (distinct'-sym d))) (depar₂ ieql) (depar₁ ieqr) par redl2 redr2  (depar₂ olieq) (depar₁ orieq) viewl2 viewr2 refl refl
      where
       oli2 = Term ∋ (q ∥ olp)
       ori2 = orq ∥ p
... | (θo , (sil@.orq ∥ sir@.olp) , (epar₂ _ ∷ Erl) , (epar₁ _ ∷ Ero) , (depar₂ oorieq) , (depar₁ oolieq) , (depar₂ sireq) , (depar₁ sileq) , rlout , rrout , viewlo , viewro , ((.Erl , .Ero , _ , _) , refl , refl))
...
... | (rolo , roloview) | (roro , roroview) = θo , sir ∥ sil , epar₁ orq ∷ Erl ,
                                                                 epar₂ olp ∷ Ero ,
                                                                 depar₁ oorieq ,
                                                                 depar₂ oolieq ,
...
... | ( θo , si , Elo , Ero , oorieq , oolieq , sireq , sileq , rlout , rrout , viewlo , viewro )
...
... | (rol , rolview) | (ror , rorview) = θo , si ∥ q , (epar₁ q) ∷ Elo , (epar₁ q) ∷ Ero , depar₁ oorieq ,
...
... | (rol , rolview) | (ror , rorview) = θo , p ∥ si , (epar₂ p) ∷ Elo , (epar₂ p) ∷ Ero , depar₂ oorieq ,
                                                                                            depar₂ oolieq , depar₂ sireq , depar₂ sileq , rol , ror , rolview , rorview
...
... | (rol , rolview) | (ror , rorview) = θo , (si >> q) , (eseq q) ∷ Elo , (eseq q) ∷ Ero , deseq oorieq ,
...
... | (rol , rolview) | (ror , rorview) = θo , (loopˢ si q) , (eloopˢ q) ∷ Elo , (eloopˢ q) ∷ Ero , deloopˢ oorieq ,
...
... | (rol , rolview) | (ror , rorview) = θo , (suspend si S) , (esuspend S) ∷ Elo , (esuspend S) ∷ Ero , desuspend oorieq ,
...
... | (rol , rolview) | (ror , rorview) = θo , (trap si) , (etrap) ∷ Elo , (etrap) ∷ Ero , detrap oorieq ,
